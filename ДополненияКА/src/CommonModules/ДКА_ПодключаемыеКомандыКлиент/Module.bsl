...
// Обработчик команды открытия формы быстрой установки товарных ограничений номенклатуры
// 
// Параметры:
//  Номенклатура - СправочникСсылка.Номенклатура - Номенклатура
//  ПараметрыВыполненияКоманды - см. ПодключаемыеКомандыКлиентСервер.ПараметрыВыполненияКоманды
Процедура БыстраяУстановкаМинМакс(Номенклатура, ПараметрыВыполненияКоманды) Экспорт
	...
	ОткрытьФорму("ОбщаяФорма.ДКА_БыстраяУстановкаМинМакс",
				 Параметры,
				 ФормаВладелец,
				 ФормаВладелец.УникальныйИдентификатор,
				 ,
