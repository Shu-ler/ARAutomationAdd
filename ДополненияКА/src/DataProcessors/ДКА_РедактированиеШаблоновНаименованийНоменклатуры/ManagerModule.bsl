...
Процедура ДобавитьКомандуНаПанельАдминистрирования(Форма) Экспорт
	...
	ИмяЭлементаФормы = "ДКА_РедактированиеШаблоновНаименованияНоменклатуры";
	ТекстЗаголовка = НСтр("ru = 'Редактирование шаблонов наименований номенклатуры'");
	ТекстПодсказки = НСтр("ru = 'Пакетная замена определенного текста в шаблонах наименований на другой текст'");
	СсылкаКоманды = "e1cib/command/ОбщаяКоманда.ДКА_РедактированиеШаблоновНаименованийНоменклатуры";
